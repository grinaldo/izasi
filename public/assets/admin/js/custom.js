...
function init_DataTables() {
    ...
    var $datatableAjax = $('#datatable-checkbox-ajax');

    var columns = [];

    $('th', $datatableAjax).each(function(index, el) {
        columns.push({
    ...
    $datatableAjax.dataTable({
        "processing": true,
        "serverSide": true,
        "ajax": $('#datatable-checkbox-ajax').data('url'),
        'order': [
            [1, 'asc']
        ],
        'columnDefs': [{
    ...
    $datatableAjax.on('draw.dt', function() {
        $('checkbox input').iCheck({
            checkboxClass: 'icheckbox_flat-green'
        });
    });
